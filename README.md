...
Independent opening and closing sounds; five original procedural presets (Chime, Paper, Arcade, Orbit, Click); per-event Off; effect volume; explicit previews; imported audio up to 5 seconds / 8 MiB; visible demo slider and Open/Close controls; private atomic settings storage; an isolated public-API hinge adapter; 29 portable tests; a dependency-free Xcode project; macOS CI for the core and the default iOS simulator build.
